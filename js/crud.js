  ...
  submitBtn.addEventListener("click", async function () {
    ...
    if (data === 1) {
      ...
      image.onload = function () {
        theWheel.addSegment({ image: "./img/" + lastItemToSegment[3], fillStyle: initialData.length - (1 % 2) == 0 ? "#5dc1d8" : "#f42d92", text: lastItemToSegment[2], imgData: image, imageDirection: "S", strokeStyle: "black" });
        theWheel.draw();
      };
